    ...
    <main className="flex-grow container mx-auto px-6 py-8">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white p-8 rounded-xl shadow-lg shadow-gray-200/50">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Datenbank-Konsole</h1>
          <p className="text-gray-500 mb-6">
            Führe SQL-Befehle direkt auf der Datenbank aus.
          </p>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Die Ausgabe des Befehls wird hier angezeigt..."
                value={output}
              />
            </div>
          </div>
